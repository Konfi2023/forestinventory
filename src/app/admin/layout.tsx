...
import { LayoutDashboard, Building2, Users, ShieldAlert, LogOut, Activity, CreditCard, Wifi, Ticket, Database } from "lucide-react";
    ...
    <div className="flex h-screen bg-slate-100">
      ...
      <aside className="w-64 bg-slate-950 text-slate-200 flex flex-col shadow-xl">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <NavLink href="/admin/data-monitor" icon={<Database />} label="Data Monitor" />
