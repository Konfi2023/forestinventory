  ...
  return (
    <footer className="border-t border-stone-100">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="inline-block mb-4">
              <svg height="22" viewBox="0 0 285 47" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: 22, width: 'auto' }}>
                ...
                <text x="58" y="33" fill="#78716c" fontFamily="sans-serif" fontWeight="500" fontSize="26" letterSpacing="-0.5">Forest</text>
                <text x="148" y="33" fill="#16a34a" fontFamily="sans-serif" fontWeight="500" fontSize="26" letterSpacing="-0.5">Manager</text>
              </svg>
            </Link>
            <p className="text-[13px] text-stone-400 leading-relaxed max-w-[220px]">
          ...
          {/* Produkt */}
          <div>
            <p className="text-[11px] text-stone-400 uppercase tracking-wider mb-4">Produkt</p>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item.href}>
                  <Link href={item.href} className="text-[13px] text-stone-400 hover:text-stone-700 transition-colors">{item.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Rechtliches */}
          <div>
            <p className="text-[11px] text-stone-400 uppercase tracking-wider mb-4">Rechtliches</p>
            <ul className="space-y-2.5">
              {[
        ...
        <div className="pt-6 border-t border-stone-100 flex flex-col md:flex-row items-center justify-between gap-3 text-[11px] text-stone-300">
          <p>&copy; {new Date().getFullYear()} Forest Manager</p>
