    ...
    <div class="np-top-nav">
        <a href="https://forest-manager.eu" title="${msg('backToHome')}" style="text-decoration: none; display: flex; align-items: center;">
            <svg height="30" viewBox="0 0 285 47" fill="none" xmlns="http://www.w3.org/2000/svg" style="height: 30px; width: auto;">
                <g>
                    <mask id="mask0_kc_up" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="47" height="47">
                        <rect width="47" height="47" fill="#D9D9D9"/>
                    </mask>
                    <g mask="url(#mask0_kc_up)">
        ...
        <div class="np-auth-container">
            <div class="np-auth-left">
                <div class="np-auth-heading">
                    <h1 class="np-auth-signup-title">${msg("updatePasswordTitle")}</h1>
                    <p class="np-auth-subtitle">${msg("updatePasswordSubtitle")}</p>
                </div>
                ...
                <form id="kc-passwd-update-form" class="np-auth-form" action="${url.loginAction}" method="post">
                    <input type="text" id="username" name="username" value="${username!''}"
                           autocomplete="username" style="display:none;" readonly />

                    <div class="np-input-group">
                        <div class="np-input-label-pill-wrapper"><span class="np-input-label-pill">${msg("passwordNew")}</span></div>
                        <input type="password" id="password-new" name="password-new" class="np-input"
                               autofocus autocomplete="new-password" />
                    </div>

                    <div class="np-input-group">
                        <div class="np-input-label-pill-wrapper"><span class="np-input-label-pill">${msg("passwordConfirmNew")}</span></div>
                        <input type="password" id="password-confirm" name="password-confirm" class="np-input"
                               autocomplete="new-password" />
                    </div>

                    <button class="np-primary-button" type="submit">${msg("updatePasswordBtn")}</button>
                </form>
            </div>
